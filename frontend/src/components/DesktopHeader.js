        ...
        <div className='desktop_header_top_right' >
          {userInfo.isPaid ? (
            ...
            <Link to='/upgrade'>
              ...
              <div className='desktop_header_top_right_upgrade_button' >
                <span>Upgrade</span>
              </div>
            </Link> 
          )}
          ...
          <div className='desktop_header_top_right_signin' >
            {userInfo ? (<> <Link to={`/myprofile/${userInfo.slug}`} >
              <img src={userInfo.image} alt='' className='desktop_header_right_profile' />
            </Link>  </>) :
              (<>
